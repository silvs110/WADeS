...
@pytest.mark.parametrize("modelling_test_scenario",
                         [
                             ...
                             AppModellingTestScenario("app_with_anomalous_higher_memory_usage", RiskLevel.high,
                                                      {AppProfileAttribute.memory_infos.name}, True),
                             AppModellingTestScenario("app_with_anomalous_lower_memory_usage", RiskLevel.medium,
                                                      {AppProfileAttribute.memory_infos.name}, True),
